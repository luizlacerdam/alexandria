...
public class PublisherController {
  ...
  public ResponseEntity<ResponseDTO<Publisher>> removePublisherById(@PathVariable Long publisherId) {
    ...
    ResponseDTO<Publisher> responseDTO = new ResponseDTO<>("Publisher removido com sucesso!", null);
    return ResponseEntity.ok(responseDTO);
  }
  ...
  public ResponseEntity<ResponseDTO<Publisher>> getPublisherById(@PathVariable Long publisherId) {
    ...
    ResponseDTO<Publisher> responseDTO = new ResponseDTO<>("Publisher encontrado com sucesso!", optionalPublisher.get());
    return ResponseEntity.ok(responseDTO);
  }
